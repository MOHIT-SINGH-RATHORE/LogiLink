...
public class UserDetailsImpl implements UserDetails {
    ...
    public static UserDetailsImpl build(Transporter transporter) {
        List<GrantedAuthority> authorities = Collections
                .singletonList(new SimpleGrantedAuthority("ROLE_" + transporter.getRole().name()));

        return new UserDetailsImpl(
                transporter.getId(),
                transporter.getUsername(),
                transporter.getPassword(),
                authorities);
    }
